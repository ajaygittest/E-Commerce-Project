...
export class FormServiceService {
  ...
  getCountries():Observable<Country[]>{
    return this.httpClient.get<GetResponseCountries>(this.countryUrl).pipe(map(response=>
  ...
  getStates(theCountryCode:string):Observable<State[]>{
    ...
    return this.httpClient.get<GetResponseStates>(searchUrl).pipe(map(response =>{
